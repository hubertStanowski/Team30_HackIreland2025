...
from .views import pub_list, pub_tabs, unpaid_pub_tabs, busy_percentage, pub_products, add_favorite_drink, remove_favorite_drink, list_favorite_drinks_by_pub, get_drink_suggestion, retrieve_tabs_history
